---
name: new-task
description: Initiates a new task workflow, setting up task planning, requirements clarification, QA plan review, user approval, and execution gating.
---
...
- When all **Pending** items are resolved, run `/close-task` to proceed with QA verification and task closure.
